...
<!--时间-->
 ...
 <section class="publicMian ">
     <div class="left">
         ...
         <nav>
             <ul class="list">
                 <li ><a href="${pageContext.request.contextPath }/jsp/blist">订单管理</a></li>
              <li><a href="${pageContext.request.contextPath }/jsp/plist">供应商管理</a></li>
              <li><a href="${pageContext.request.contextPath }/jsp/list">用户管理</a></li>
              <li><a href="${pageContext.request.contextPath }/jsp/redirectp">密码修改</a></li>
